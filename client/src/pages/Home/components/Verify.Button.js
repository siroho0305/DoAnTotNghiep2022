...
const VerifyButton = props => {
    ...
    const handleVerify = async () => {
        if(bcAddressSlice?.data) {
            ...
            setFirstStepContent("Verifying asset")
            ...
            setTimeout(async() => {
                ...
                if(verify_res?.success) {
                    ...
                    setFirstStepContent("Verify asset success")

                    setIsFinalStep(true)
                    if(verify_res?.can_create) {
                        setFinalStepStatus("error")
                        setIsVerifyFail(true)
                        setFinalStepContent("This NFT is not published")
                    }
                    else {
                        setIsVerified(true)
                    ...
                    setFirstStepContent("Verify asset failure")
                }
            }, 1000);
        }
        else {
